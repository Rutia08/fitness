...
var gymLink = document.querySelector('[data-gym-link]');
var button = document.querySelector('[data-gym-button]');
var url = gymVideo.getAttribute('data-video-url');
...
gymVideo.addEventListener('click', function () {
  var iframe = createIfrarme(videoId);
  gymLink.remove();
  button.remove();
  gymVideo.appendChild(iframe);
});
function genereateURL(id) {
  var query = '?rel=0showinfo=0&autoplay=1';
  return 'https://www.youtube.com/embed/' + id + query;
}
var couches = document.querySelector('[data-couches]');
