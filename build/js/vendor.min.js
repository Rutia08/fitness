...
/*!**********************!*\
  !*** ./js/vendor.js ***!
  \**********************/
/*! no exports provided */function(e,t,a){"use strict";a.r(t);a(/*! ./vendor/swiper */"./js/vendor/swiper.js"),a(/*! ./vendor/focus-visible-polyfill */"./js/vendor/focus-visible-polyfill.js");var i=document.querySelector("[data-gym-video]"),s=document.querySelector("[data-gym-link]"),r=document.querySelector("[data-gym-button]"),n=i.getAttribute("data-video-url");s.removeAttribute("href");var o=/^https?\:\/\/(www\.)?youtu\.be/.test(n)?n.replace(/^https?\:\/\/(www\.)?youtu\.be\/([\w-]{11}).*/,"$2"):n.replace(/.*\?v\=([\w-]{11}).*/,"$1");i.addEventListener("click",(function(){var e=function(e){var t=document.createElement("iframe");return t.setAttribute("src","https://www.youtube.com/embed/"+e+"?rel=0showinfo=0&autoplay=1"),t.setAttribute("allowfullscreen",""),t.setAttribute("frameborder","0"),t.setAttribute("allow","autoplay"),t}(o);s.remove(),r.remove(),i.appendChild(e)}));var l=document.querySelector("[data-couches]"),d=document.querySelector("[data-reviews]");l.classList.remove("nojs"),d.classList.remove("nojs");var c=document.querySelector("[data-swiper-1-prev]"),p=document.querySelector("[data-swiper-1-next]"),u=new Swiper(".swiper-1",{direction:"horizontal",slidesPerView:1,loop:!0,breakpoints:{768:{slidesPerView:2,spaceBetween:30},1200:{slidesPerView:4,spaceBetween:40}}});c.addEventListener("click",(function(){u.slidePrev()})),p.addEventListener("click",(function(){u.slideNext()}));var h=document.querySelector("[data-swiper-2-prev]"),f=document.querySelector("[data-swiper-2-next]"),v=document.querySelectorAll("[data-slide-swiper-2]"),m=new Swiper(".swiper-2",{direction:"horizontal",slidesPerView:1});0===m.realIndex&&h.classList.add("disabled");var g=function(){0===m.realIndex?h.classList.add("disabled"):h.classList.remove("disabled"),m.realIndex>=v.length/2?f.classList.add("disabled"):f.classList.remove("disabled")};m.on("transitionEnd",(function(){g()})),h.addEventListener("click",(function(){m.slidePrev(),g()})),f.addEventListener("click",(function(){m.slideNext(),g()})),document.querySelectorAll(".swiper-slide-duplicate").forEach((function(e){e.removeAttribute("tabindex")}))},"./js/vendor/focus-visible-polyfill.js":
/*!*********************************************!*\
