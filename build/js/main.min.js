...
window.addEventListener('DOMContentLoaded', function () {
  ...
  // ---------------------------------
  // form
  var inputName = document.querySelector('[data-name-input]');
  var inputPhone = document.querySelector('[data-phone-input]');
  ...
  var keyPressHandler1 = function keyPressHandler1(evt) {
    if (evt.keyCode !== 43) {
  ...
  var keyPressHandler2 = function keyPressHandler2(evt) {
    if (evt.keyCode < 47 || evt.keyCode > 57) {
      evt.preventDefault();
    }
  };
