...
/* harmony import */ var _vendor_youtube_video__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./vendor/youtube-video */ "./js/vendor/youtube-video.js");
// Swiper 7.4.1
...
var swiperPrev1 = document.querySelector('[data-swiper-1-prev]');
var swiperNext1 = document.querySelector('[data-swiper-1-next]');
...
var swiperPrev2 = document.querySelector('[data-swiper-2-prev]');
var swiperNext2 = document.querySelector('[data-swiper-2-next]');
var slides2 = document.querySelectorAll('[data-slide-swiper-2]');
...
;
var buttonDisable2 = function buttonDisable2() {
  if (swiper2.realIndex === 0) {
    swiperPrev2.classList.add('disabled');
  } else {
...
// youtube
var gymVideo = document.querySelector('[data-gym-video]');
var gymPoster = document.querySelector('[data-gym-poster]');
var gymButton = document.querySelector('[data-gym-button]');
...
/***/ "./js/vendor/youtube-video.js":
/*!************************************!*\
  !*** ./js/vendor/youtube-video.js ***!
  \************************************/
/*! exports provided: YoutubeVideoElement */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "YoutubeVideoElement", function() { return r; });
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
...
var t = function t(_t) {
  return _t ? "string" == typeof _t && (_t = [_t]) : _t = [], _t;
};
var e = new ( /*#__PURE__*/function () {
    ...
    _createClass(_class, [{
      key: "loadScript",
      value: function () {
        var _loadScript = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
          var _this = this;
          var s, r, i;
          return _regeneratorRuntime().wrap(function _callee$(_context) {
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  i = [];
                  return _context.abrupt("return", ((e = t(e)).forEach(function (t) {
                    r = _this._scriptMaps[t] = _this._scriptMaps[t] || {}, r.promise || (r.path = t, r.promise = new Promise(function (e) {
                      s = _this.createScriptElement(), s.setAttribute("type", "text/javascript"), s.src = t, s.addEventListener("load", e), _this._head.appendChild(s);
                    })), i.push(r.promise);
                  }), Promise.all(i)));
                case 2:
                case "end":
      ...
      key: "unloadScript",
      value: function () {
        var _unloadScript = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(e) {
          var _this2 = this;
          var s;
                ...
                case 0:
                  return _context2.abrupt("return", new Promise(function (r) {
                    (e = t(e)).forEach(function (t) {
                      s = _this2._head.querySelectorAll('script[src="' + t + '"]')[0], s && (_this2._head.removeChild(s), delete _this2._scriptMaps[t]);
                    }), r();
                  }));
                case 1:
                case "end":
      ...
      key: "fetchData",
      value: function () {
        var _fetchData = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(t) {
          var e,
            s,
            _args3 = arguments;
            ...
            while (1) {
              switch (_context3.prev = _context3.next) {
                case 0:
                  ...
                  s = t + JSON.stringify(e);
                  if (!(e.cache = void 0 === e.cache || e.cache, !t)) {
                    _context3.next = 4;
                    break;
                  }
                  return _context3.abrupt("return", Promise.resolve());
                case 4:
                  if (!(!this._dataPromises[s] || !e.cache)) {
                    _context3.next = 14;
                    break;
                  }
                  _context3.prev = 5;
                  ...
                  return fetch(t, e);
                case 8:
                  this._dataPromises[s] = _context3.sent;
                  _context3.next = 14;
                  break;
                case 11:
                  _context3.prev = 11;
                  _context3.t0 = _context3["catch"](5);
                  throw this._dataPromises[s] = null, _context3.t0;
                case 14:
                  return _context3.abrupt("return", this._dataPromises[s]);
                case 15:
                case "end":
      ...
      key: "loadCss",
      value: function () {
        var _loadCss = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(e) {
          var _this3 = this;
          return _regeneratorRuntime().wrap(function _callee4$(_context4) {
            while (1) {
              switch (_context4.prev = _context4.next) {
                case 0:
                  return _context4.abrupt("return", new Promise(function (s) {
                    (e = t(e)).forEach(function (t) {
                      if (!_this3._cssPaths[t]) {
                        var _e = document.createElement("link");
                        _e.setAttribute("rel", "stylesheet"), _e.setAttribute("href", t), _this3._head.appendChild(_e), _this3._cssPaths[t] = _e;
                      }
                    }), s();
                  }));
                case 1:
      ...
      key: "unloadCss",
      value: function () {
        var _unloadCss = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(e) {
          var _this4 = this;
          var s;
              ...
              switch (_context5.prev = _context5.next) {
                case 0:
                  return _context5.abrupt("return", new Promise(function (r) {
                    (e = t(e)).forEach(function (t) {
                      s = _this4._cssPaths[t], s && (_this4._head.removeChild(s), _this4._cssPaths[t] = null);
                    }), r();
                  }));
                case 1:
                case "end":
      ...
      key: "loadTemplate",
      value: function () {
        var _loadTemplate = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6(t, e) {
          var s;
          return _regeneratorRuntime().wrap(function _callee6$(_context6) {
            while (1) {
              switch (_context6.prev = _context6.next) {
                ...
                case 2:
                  _context6.next = 4;
                  return this.fetchTemplate(t);
                case 4:
                  s = _context6.sent;
                  return _context6.abrupt("return", e ? (e.innerHTML = s, e) : s);
                case 6:
                case "end":
      ...
      key: "fetchTemplate",
      value: function () {
        var _fetchTemplate = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee7(t) {
          var e;
      ...
      key: "flush",
      value: function () {
        var _flush = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee8() {
          var _t2, _e2;
            ...
            while (1) {
              switch (_context8.prev = _context8.next) {
                ...
                case 4:
                  ...
                  _t2 = _context8.t1.value;
                  if (!this._scriptMaps.hasOwnProperty(_t2)) {
                    _context8.next = 10;
                    break;
                  }
                  _e2 = this._scriptMaps[_t2];
                  _context8.next = 10;
                  return this.unloadScript(_e2.path);
                case 10:
                  _context8.next = 4;
                  break;
                case 12:
                  this._scriptMaps = {}, this._dataPromises = {};
                case 13:
                case "end":
...
var r = /*#__PURE__*/function (_HTMLElement) {
  ...
  function r() {
    ...
    (_this5 = _super.call(this), _defineProperty(_assertThisInitialized(_this5), "ytPlayer", void 0), _defineProperty(_assertThisInitialized(_this5), "paused", !0), _defineProperty(_assertThisInitialized(_this5), "ytPlayerContainer", void 0), _defineProperty(_assertThisInitialized(_this5), "resolveBuildPlayerPromise", null), _defineProperty(_assertThisInitialized(_this5), "ytPlayerPromise", null), _defineProperty(_assertThisInitialized(_this5), "scriptPath", "https://www.youtube.com/iframe_api"), _defineProperty(_assertThisInitialized(_this5), "mediaError", void 0)), s.set(_assertThisInitialized(_this5), _this5.id);
    return _this5;
  }
  _createClass(r, [{
    ...
    value: function disconnectedCallback() {
      s.delete(this), this.resolveBuildPlayerPromise && this.resolveBuildPlayerPromise(), this.ytPlayer && this.ytPlayer.destroy(), s.size || (s.clear(), this.unloadYTScript());
    }
  }, {
    key: "height",
    get: function get() {
    ...
    key: "id",
    get: function get() {
      return this.getAttribute("id") || "ytPlayer-" + s.size;
    }
  }, {
    key: "controls",
    get: function get() {
      return this.hasAttribute("controls") || !0;
    }
  }, {
    key: "ytPlayerVars",
    get: function get() {
      var t = this.srcQueryParams;
    ...
    get: function get() {
      ...
      try {
        for (_iterator.s(); !(_step = _iterator.n()).done;) {
          var _t3 = _step.value;
          var _e3 = _t3.split("=", 2);
          1 === _e3.length ? s[_e3[0]] = "" : s[_e3[0]] = decodeURIComponent(_e3[1].replace(/\+/g, " "));
        }
      } catch (err) {
        _iterator.e(err);
      } finally {
    ...
    key: "load",
    value: function () {
      var _load = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee9() {
    ...
    key: "videoId",
    get: function get() {
      var t = new RegExp("https?:\\/\\/(?:[0-9A-Z-]+\\.)?(?:youtu\\.be\\/|youtube(?:-nocookie)?\\.com\\S*[^\\w\\s-])([\\w-]{11})(?=[^\\w-]|$)(?![?=&+%\\w.-]*(?:['\"][^<>]*>|<\\/a>))[?=&+%\\w.-]*", "ig");
    ...
    value: function onPlay() {
      var _this6 = this;
      this.paused = !1, s.forEach(function (t, e) {
        e === _this6 || e.paused || e.pause();
    ...
    value: function _onYTApiStateChange(t) {
      var e = {
          "-1": "unstarted",
          0: "ended",
          1: "playing",
      ...
      if (s[e]) {
        var _t4 = s[e];
        _t4 && (_t4.call(this), this.dispatchEvent(new CustomEvent(e)));
      }
    }
  }, {
    key: "loadYTScript",
    value: function loadYTScript() {
      var _this7 = this;
      return r.scriptLoadPromise || (r.scriptLoadPromise = new Promise(function (t) {
        return window.onYouTubeIframeAPIReady || (r.triggerYoutubeIframeAPIReady = t, window.onYouTubeIframeAPIReady = function () {
          window.onYouTubeIframeAPIReady = null, r.triggerYoutubeIframeAPIReady();
        }), e.loadScript(_this7.scriptPath);
      })), r.scriptLoadPromise;
    }
  }, {
    key: "unloadYTScript",
    value: function unloadYTScript() {
      e.unloadScript(this.scriptPath), r.scriptLoadPromise = null;
    }
  }, {
    key: "buildPlayer",
    value: function buildPlayer() {
      var _this8 = this;
      return this.ytPlayerPromise || (this.ytPlayerPromise = new Promise(function (t) {
        var e = {
          events: {
            ...
            onReady: function onReady(e) {
              _this8.dispatchEvent(new CustomEvent("loadstart")), _this8.dispatchEvent(new CustomEvent("canplay")), _this8.resolveBuildPlayerPromise = t, t(e.target);
            },
            onStateChange: function onStateChange(t) {
              return _this8._onYTApiStateChange(t);
            }
          },
        ...
        _this8.ytPlayer = new YT.Player(_this8.ytPlayerContainer, e);
      })), this.ytPlayerPromise;
    }
  }]);
  return r;
}( /*#__PURE__*/_wrapNativeSuper(HTMLElement));
_defineProperty(r, "scriptLoadPromise", null);
_defineProperty(r, "triggerYoutubeIframeAPIReady", null);
customElements.define("youtube-video", r);
